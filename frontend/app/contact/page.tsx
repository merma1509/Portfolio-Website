    ...
    <>
      <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 p-6">
        <nav className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="space-x-6">
            ...
            <a href="/contact" className="text-slate-600 hover:text-slate-800 dark:text-slate-300 dark:hover:text-white font-semibold">Contact</a>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 py-16">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 dark:text-white mb-8 text-center">Contact</h1>
          ...
          <div className="max-w-2xl mx-auto mb-16">
            <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-slate-700 dark:text-slate-300 mb-2 font-medium">Name</label>
                  <input
                    type="text"
                    id="name"
                    value={formData.name}
                    onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                    className={`w-full p-4 border rounded-lg bg-slate-50 dark:bg-slate-700 text-slate-800 dark:text-white focus:ring-2 focus:ring-slate-500 focus:border-transparent ${errors.name ? 'border-red-500' : 'border-slate-300 dark:border-slate-600'}`}
                    required
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-4 border rounded-lg bg-slate-50 dark:bg-slate-700 text-slate-800 dark:text-white focus:ring-2 focus:ring-slate-500 focus:border-transparent ${errors.email ? 'border-red-500' : 'border-slate-300 dark:border-slate-600'}`}
                    required
                  />
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      className={`flex-1 p-4 border border-l-0 border-slate-300 dark:border-slate-600 rounded-r-lg bg-slate-50 dark:bg-slate-700 text-slate-800 dark:text-white focus:ring-2 focus:ring-slate-500 focus:border-transparent ${errors.phone ? 'border-red-500' : ''}`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full p-4 border rounded-lg bg-slate-50 dark:bg-slate-700 text-slate-1000 dark:text-white focus:ring-2 focus:ring-slate-500 focus:border-transparent ${errors.message ? 'border-red-500' : 'border-slate-300 dark:border-slate-600'}`}
                    rows={6}
                    required
                  />
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-lg transition font-semibold ${
                    isSubmitting
              ...
              {status && <p className={`mt-4 text-center font-medium ${status.includes('success') ? 'text-green-600' : 'text-red-600'}`}>{status}</p>}
            </div>
          </div>
        </div>

        <footer className="bg-slate-100/50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 py-8">
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex justify-center items-center space-x-8">
              ...
              <a href="https://linkedin.com/in/nshuti-martin15" className="group" target="_blank" rel="noopener noreferrer">
                <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://instagram.com/nshuti-martin15" className="group" target="_blank" rel="noopener noreferrer">
                <div className="w-12 h-12 bg-gradient-to-br from-pink-500 via-purple-500 to-orange-400 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://github.com/merma1509" className="group" target="_blank" rel="noopener noreferrer">
                <div className="w-12 h-12 bg-gradient-to-br from-gray-800 to-gray-900 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-200">
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
